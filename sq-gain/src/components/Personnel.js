...
import philippaG from '../images/PhilippaGill.png';
  ...
  return (
    <StyledPersonnel>
      ...
      <p>
        ...
        local authorities, blue-chip multinationals, SMEs, research and third
        ...
        <div className="position">
          ...
          <div className="biog">
            <p>
              ...
              content management platform, Articulate 360 Storyline and Litmos.
            </p>
            <div className="personnel-line"></div>
          </div>
        </div>
        ...
        <div className="position">
          ...
          <div className="biog">
            <p>
              ...
              commercial acumen developed through roles in risk management,
              asset management and sustainability leadership for real estate,
        ...
        <div className="position">
          ...
          <div className="biog">
            <p>
              ...
              buildings, particularly in nascent green building markets, and is
              currently leading a "Green Homes & Green Mortgage" program with
              over 4,000 residential units, providing discounted interest rates
              for environmentally-responsible, energy-efficient, and healthy
              homes.
            </p>
            <div className="personnel-line"></div>
          </div>
      ...
      <div className="person">
        <h2>
          <span>Philippa Gill</span>
        </h2>
        <img src={philippaG} alt="philippaG" />

        <div className="position">
          <h4>Associate</h4>
          <div className="biog">
            <p>
              Philippa is a senior operations and real estate professional, with
              over 15 years' experience in asset management, property operations
              and sustainability on both a pan-European and global basis. She
              now works across financial, operational and sustainability
              performance at a strategic level as well as for individual assets.
            </p>
            <div className="personnel-line"></div>
          </div>
        </div>
        ...
        <div className="position">
          ...
          <div className="biog">
            <p>
              ...
              project and operational management, marketing, communications and
      ...
      <div className="person">
        ...
        <div className="position">
          ...
          <div className="biog">
            <p>
              Greg is a Chartered Surveyor and sustainability professional with
              17 years industry experience on business engagement, negotiations,
